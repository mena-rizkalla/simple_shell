...
/**
 * struct variablesShell - variables
...
/**
 * struct builtinFunc - struct for the builtin functions
...
ssize_t putsF(char *str);
char *_strdup(char *strtodup);
int strCmpr(char *strcmp1, char *strcmp2);
